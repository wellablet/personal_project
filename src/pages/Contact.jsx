        ...
        <footer className="border-t border-gray-100 pt-12">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center gap-12 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">abletBaba@email.com</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="p-3 bg-sky-50 rounded-full">
            ...
            <div className="flex space-x-6 mb-8">
              <a
                href="https://github.com/wellablet"
                className="p-3 bg-gray-50 rounded-full text-gray-600 hover:bg-sky-50 hover:text-sky-500 transition-colors"
              >
                <FaGithub size={20} />
              </a>
              <a
                href="https://www.linkedin.com/in/ablet-a-40a73124b/"
                className="p-3 bg-gray-50 rounded-full text-gray-600 hover:bg-sky-50 hover:text-sky-500 transition-colors"
              >
                <FaLinkedin size={20} />
              </a>
